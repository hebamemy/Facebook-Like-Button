...
require_once('pressGraphLike.php');


/**
 * PressGraphLikeCustom class.
 *
 * @extends PressGraphLike
 */
class PressGraphLikeCustom extends PressGraphLike
{
	...
	public function DisablePages()
	{
		if(function_exists('add_meta_box')){
			add_meta_box('fb-like', 'Facebook Like Options', array('PressGraphLikeCustom', 'LikeBoxLayout'), 'page', 'side', 'default', null );

		}else{
			add_action('dbx_page_advanced', array('PressGraphLikeCustom', 'LikeBoxLayout'));

		}

		if(function_exists('add_meta_box')){
			add_meta_box('fb-like', 'Facebook Like Options', array('PressGraphLikeCustom', 'LikeBoxLayout'), 'post', 'side', 'default', null );
	...
	/**
	 * advancedShortCut function.
	 * 
	 * @access public
	 * @param array $attrs
	 * @return void
	 */
	public function advancedShortCut($attrs){
